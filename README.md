...
# Тестирование
e2e можно запустить с помощью:

`make e2e`

работает и с параллельно работающим основным приложением 

Нагрузочное тестирование можно запустить с помощью:

`make loadtest`

работает только при запущенном основном приложении
